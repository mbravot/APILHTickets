...
# Usando el proxy de Cloud SQL local (más estable que conexión TCP directa)
os.environ['DATABASE_URL'] = 'mysql+pymysql://UserApp:&8y7c()tu9t/+,6`@127.0.0.1:3306/lahornilla_base_normalizada'
os.environ['SECRET_KEY'] = 'Inicio01*'
os.environ['JWT_SECRET_KEY'] = 'Inicio01*'
os.environ['FLASK_ENV'] = 'development'
os.environ['FLASK_DEBUG'] = '1'

print("✅ Variables de entorno configuradas para Google Cloud SQL (usando proxy local)") 